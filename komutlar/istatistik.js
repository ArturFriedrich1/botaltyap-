...
exports.run = async (client, message, args) => {
  ...
  const istatistikler = new Discord.MessageEmbed()
    ...
    .addField("**» Bot Davet**"," [Davet Et](=" + client.user.id + "https://discord.com/oauth2/authorize?client_id=865122301070802974&scope=bot&permissions=805306430)");
